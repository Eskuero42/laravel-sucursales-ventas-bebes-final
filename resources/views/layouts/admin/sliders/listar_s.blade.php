...
@section('contenido')
    <div class="container-fluid">
        <div class="alert alert-info text-center mb-4 fs-22">
                                                        ...
                                                        <div class="card-body p-3 d-flex flex-column">
                                                            ...
                                                            <div class="mt-3 flex-grow-1 d-flex flex-column">
                                                                ...
                                                                <div class="hstack gap-2 mt-auto">
                                                                    <button type="button"
                                                                        class="btn btn-soft-warning btn-icon waves-effect waves-light editIconoBtn w-100"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow-sm rounded-4">
                ...
                <form id="updateIconoForm" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="sucursal_id" id="updateIconoSucursalId">
                    <div class="modal-body">
            ...
            $(document).ready(function() {
                ...
                $('#addIconoForm').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            alert('Error: ' + (xhr.responseJSON?.msg || 'Ocurrió un error'));
                            $('.addIconoBtn').prop('disabled', false);
                        }
                    });
                });
                ...
                $('#sliderList').on('click', '.editBtn', function() {
                    ...
                    $('#updateSucursalId').val(data.sucursal_id); // ⬅️ Agregado
                ...
                $('#iconosTab').on('click', '.editIconoBtn', function() {
                    ...
                    $('#updateIconoSucursalId').val(data.sucursal_id); // ⬅️ IMPORTANTE
